...
JAVA_OPTS="-server -Xms65m -Xmx65m -XX:+UseG1GC -XX:MaxGCPauseMillis=400 -XX:+HeapDumpOnOutOfMemoryError
-XX:HeapDumpPath=logs/assembly.memory.dump -XX:+PrintGCDetails -XX:+PrintGCTimeStamps 
-XX:+PrintGCApplicationStoppedTime -Xloggc:logs/assembly.gc.log
"

java $JAVA_OPTS -classpath $CLASSPATH com.sand.abacus.assembly.bootstrap.ProductBootstrap
