...
<div class="content-wrapper">
    ...
    <section class="content">
        <form role="form" method="POST" action="/io">
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <a class="btn btn-sm btn-info btn-flat" href="/io/add">添加IO服务</a>
                            <div class="box-tools">
                                <div class="input-group" style="width: 150px;">
                                    <input type="text" name="search" class="form-control input-sm pull-right"
                                           placeholder="Search" value="${ioModel.search}">
                            ...
                            <table class="table table-hover">
                                ...
                                <e:forEach items="${list}" var="item">
                                    <tr>
                                        ...
                                        <td>${item.comments}</td>
                                        <td>
                                            <a href="#" onclick="submitForm(this, '/io/modify/?id=${item.id}')" class="btn btn-xs btn-default">修改</a>
                                            <e:choose>
                                                <e:when test="${item.status == '10'}">
                                                    <a href="#" onclick="submitForm(this, '/io/enable/?id=${item.id}')" class="btn btn-xs btn-info">启用</a>
                                                </e:when>
                                                <e:otherwise>
                                                    <a href="#" onclick="submitForm(this, '/io/disable/?id=${item.id}')" class="btn btn-xs btn-warning">禁用</a>
                                                </e:otherwise>
                                            </e:choose>
                                        </td>
                                    </tr>
