...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/notice">推送服务</a></li>
            <li><a href="#">
                <c:choose>
                    <c:when test="${noticeModel.id == null}">
                        添加
                    </c:when>
                    <c:otherwise>
                        修改
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-body">
                <form role="form" data-toggle="validator" method="POST" action="/notice/save">
                    <input type="hidden" name="id" value="${noticeModel.id}">
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group" style="margin-bottom: 0px">
                                <label>服务名<span style="color: red">*</span></label>
                                <input type="text" name="name" class="form-control" id="inputName" maxlength="30"
                                       placeholder="自定义名称" value="${noticeModel.name}" required>
                        ...
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <select class="form-control" name="protocol" id="inputProtocol" required>
                                    <option <c:if test="${noticeModel.protocol == 'ftp'}">selected="selected"</c:if> value="MQTT">MQTT</option>
                                </select>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <input type="text" name="host" class="form-control" id="inputHost" maxlength="30"
                                       placeholder="IP地址" value="${noticeModel.host}" data-inputmask="'alias': 'ip'" data-mask required>
                        ...
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <input type="number" min="1" name="port" class="form-control" id="inputPort"
                                       placeholder="大于0" value="${noticeModel.port}" required>
                        ...
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <input type="text" name="userName" class="form-control" id="inputUserName" maxlength="30"
                                       placeholder="连接时用户名" value="${noticeModel.userName}">
                            </div>
                        </div>
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <input type="password" name="userPwd" class="form-control" id="inputUserPwd" maxlength="500"
                                       placeholder="连接时用户密码" value="${noticeModel.userPwd}" autocomplete="new-password">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <input type="number" min="1" name="timeout" class="form-control" id="inputTimeout"
                                       placeholder="单位秒" value="${noticeModel.timeout}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <input type="number" min="1" name="keepAlive" class="form-control" id="inputKeepAlive"
                                       placeholder="单位秒" value="${noticeModel.keepAlive}" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                ...
                                <textarea name="options" class="form-control" id="inputOptions" maxlength="1000"
                                       placeholder="Json格式">${noticeModel.options}</textarea>
                            </div>
                        </div>
                        <div class="form-group" style="margin-bottom: 0px">
                            <div class="col-xs-6">
                                <label>备注</label>
                                <textarea name="comments" class="form-control" id="inputComments">${noticeModel.comments}</textarea>
                            </div>
                        </div>
                    </div>
